...
public class Timesheet implements java.io.Serializable {
    ...
    /** Whether or not the timesheet has been submitted for approval. */
	private boolean submittedForApproval;

    /** Whether or not the timesheet has been approved. */
	private boolean approved;

	/** when approver denies a timesheet */
    ...
    //    System.out.println("current day" + currentDay);
     //   System.out.println("left day" + leftDays);
	...
	public void setSubmittedForApproval(boolean needsReviewing) {
		this.submittedForApproval = needsReviewing;
	}
